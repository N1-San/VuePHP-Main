...
<div class="min-h-full">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/contact" active="sdakjsd">Contact</x-nav-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Robo Guy</div>
            <div class="text-sm font-medium leading-none text-gray-400">robo@guy.com</div>
          </div>
  ...
  <main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
      Slotted Content goes here {{ $slot }}
    </div>
  </main>
</div>
